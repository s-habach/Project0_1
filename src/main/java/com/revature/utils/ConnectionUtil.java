...
public class ConnectionUtil {
    ...
    public static Connection getConnection() throws SQLException {
        ...
        try {
            Class.forName("org.postgresql.Driver"); //searching for the postgres
            // driver, which we have as a dependency
        ...
        //Hardcoded for now... BAD! we can change this to hide them in the Environment
        // Variables

        //I'm going to put the credentials in Strings, and use those strings in a method that
        // gets connections
        String url = "jdbc:postgresql://localhost:5432/postgres?currentSchema=project0_1";
        ...
        //Run -> Edit Configurations -> Application -> Then create key/value pairs for these
        // credentials
        //Right click Launcher and run it if you don't see these options (creates an
        // application config)
